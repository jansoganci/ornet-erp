-- Expose vat_rate and has_tevkifat on work_orders_detail (columns exist on work_orders; view 00100 omitted them).
-- Enables fetchWorkOrder / useWorkOrder to read VAT and tevkifat for detail UI.
...
-- CASCADE drops functions that RETURN SETOF work_orders_detail — restore latest definitions (00123, 00126).
