...
--
-- Align Tahsilat document/customer settlement views with the active payment
-- contract introduced by 00242:
...
-- - collected payments sum from COALESCE(financial_transaction_payments.amount, amount_try)
