-- Migration: 00061_fix_sim_card_to_finance_logic
-- Description: Fix SIM-to-Finance trigger: allow NULL site_id (wholesale), require only customer_id,
-- correct status logic: subscription/cancelled=skip, available=expense only, active=income+expense (wholesale) or expense only.
